...
# var all_strategy_card_names = ["PlayEmTight", "CleanTheGlass", "BlinkAndYoullMissHim", "PowerMove", "HesHeatingUp", "Layup", "ClutchShot", "BoxingOut", "GoodPosition", "HalfCourtSet", "GetTheCrowdIntoIt", "Jumper", "FromWayDowntown", "ToughShot", "ChaseDownBlock", "AndOne", "CornerThree", "DefensiveRebound", "KillerCrossover"]
var all_strategy_card_names = ["HotStart"]
