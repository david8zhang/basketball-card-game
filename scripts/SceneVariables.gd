...
var all_strategy_card_names = ["PlayEmTight", "CleanTheGlass", "TakeTheCharge", "BlinkAndYoullMissHim", "PowerMove", "SlamDunk", "HesHeatingUp", "Layup", "ClutchShot", "BoxingOut", "GoodPosition", "HalfCourtSet", "GetTheCrowdIntoIt", "Jumper", "FromWayDowntown", "HotStart", "ToughShot", "ChaseDownBlock", "AndOne", "CornerThree", "DefensiveRebound", "Rejected", "KillerCrossover", "ThreePointer"]
